...
def main() -> None:
    ...
    with col2:
        # Header says "window scatter", not "PCA projection": this panel plots
        # entropy_dst vs entropy_src COLORED by verdict_pca, it does not project
        # into PCA space. The real 2D projection is the figure in README
        # §Evaluation, generated by notebooks/train_pca_and_rf.py.
        st.markdown("### Panel 3: Window scatter, colored by PCA verdict")
